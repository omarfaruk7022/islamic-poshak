      ...
      <div class="px-4 py-6">
        <nav aria-label="Main Nav" class="mt-6 flex flex-col space-y-1">
          <Link
            ...
            class="flex items-center gap-2 rounded-lg px-4 py-2 text-black  "
          >
          ...
          <details class="group [&_summary::-webkit-details-marker]:hidden">
            <summary class="flex cursor-pointer items-center justify-between rounded-lg px-4 py-2 text-black  ">
          ...
          <details class="group [&_summary::-webkit-details-marker]:hidden">
            ...
            <nav aria-label="Account Nav" class="mt-2 flex flex-col px-4">
              ...
              <form action="/logout">
                <button
                  type="submit"
                  class="flex w-full items-center gap-2 rounded-lg px-4 py-2 text-black "
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-5 w-5 opacity-75"
