                    ...
                    <tr>
                      ...
                      <td className="whitespace-nowrap px-4 py-2 text-gray-700 r dark:text-gray-200">
                        {product?.status === "in-stock" && (
                          <span
                          class="inline-flex items-center justify-center rounded-full bg-emerald-200 dark:bg-green-400 px-2.5 py-0.5 text-emerald-700 dark:text-emerald-900"
                        >
                          <svg
                        ...
                        {product?.status === "out-of-stock" && (
                          <span
                          class="inline-flex items-center justify-center rounded-full bg-red-100 dark:bg-red-200 px-2.5 py-0.5 text-red-700 dark:text-red-00"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
                          ...
                          <p class="whitespace-nowrap text-sm">Out-of-stock</p>
